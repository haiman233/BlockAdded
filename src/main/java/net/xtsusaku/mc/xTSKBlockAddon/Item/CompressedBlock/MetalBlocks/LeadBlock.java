...
public class LeadBlock extends AbstractCompressedBlock {

    public LeadBlock(ItemGroup itemGroup) {
        super(itemGroup, SlimefunItems.LEAD_INGOT.clone(), Material.IRON_BLOCK, Material.IRON_INGOT, "X_SF_LEAD", "&bLead Block");
    }
