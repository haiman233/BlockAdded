...
public class TinBlock extends AbstractCompressedBlock {

    public TinBlock(ItemGroup itemGroup) {
        super(itemGroup, SlimefunItems.TIN_INGOT.clone(), Material.IRON_BLOCK, Material.IRON_INGOT, "X_SF_TIN", "&bTin Block");
    }
