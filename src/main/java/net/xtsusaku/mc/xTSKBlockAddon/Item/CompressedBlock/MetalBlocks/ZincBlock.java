...
public class ZincBlock extends AbstractCompressedBlock {

    public ZincBlock(ItemGroup itemGroup) {
        super(itemGroup, SlimefunItems.ZINC_INGOT.clone(), Material.IRON_BLOCK, Material.IRON_INGOT, "X_SF_ZINC", "&bZinc Block");
    }
