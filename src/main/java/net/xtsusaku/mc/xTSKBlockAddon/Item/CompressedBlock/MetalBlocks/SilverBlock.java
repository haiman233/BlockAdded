...
public class SilverBlock extends AbstractCompressedBlock {

    public SilverBlock(ItemGroup itemGroup) {
        super(itemGroup, SlimefunItems.SILVER_INGOT.clone(), Material.IRON_BLOCK, Material.IRON_INGOT, "X_SF_SILVER", "&bSilver Block");
    }
